  ...
  (let [files
        [(when (= db :mongodb)
         ...
         (if (= db :mongodb)
           ...
           ["{{sanitized-site}}/src/{{sanitized-site}}/controllers/home/core.clj" (render "src/controllers/home/core_site_int.clj" data)])
...
(defn models-files
  [data]
  [["{{sanitized-site}}/src/{{sanitized-site}}/models/home.clj" (render "src/models/home.clj" data)]
  ...
  (let [files
        [(when (= db :mongodb)
         ...
         (if (= db :mongodb)
           ...
           ["{{sanitized-site}}/test/{{sanitized-site}}/integration/controllers/home/core.clj" (render "test/integration/controllers/home/core_site_int.clj" data)])
         (if (= db :mongodb)
           ...
           ["{{sanitized-site}}/test/{{sanitized-site}}/unit/controllers/home/core.clj" (render "test/unit/controllers/home/core_site_int.clj" data)])
